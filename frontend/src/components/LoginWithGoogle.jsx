...
const LoginWithGoogle = () => {
    ...
    return (
      ...
      className="gsi-material-button flex items-center justify-center gap-3 px-5 py-2 border border-gray-300 rounded-md shadow-md bg-white hover:bg-gray-100 transition duration-200 w-full"
    >
